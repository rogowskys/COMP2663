...
/**
 * Allows a transaction to be processed through the system.
 */
public class transaction {
	...
	/**
	 * Creates the new transaction in progress.
	 *
	...
	/**
	 * Adds new lines for each item in the transaction.
	 *
	 * @param newLineItem item being processed
	 * @param quantity quantity of item being processed
	 */
	...
	/**
	 * Removes unwanted items from transaction.
	 *
	 * @param index line to be removed from transaction
	 */
